...
(function() {
  ...
  window.fetchPendingDocs = async function() {
...
`;
  ...
  window.loadRequestInventory = async function() {
    try {
  ...
  window.loadRequestorList = async function() {
    try {
  ...
  window.onRequestorChange = function() {
    const sel = document.getElementById('reqRequestor');
    if (!sel) return;
  ...
  window.lookupSofData = async function() {
  ...
  window.loadVendorList = async function() {
    try {
  ...
  window.loadIvmTeamList = async function() {
    try {
  ...
  // ─── ────────────────────────────────────────────────────────────────
  console.log('✅ warehouse.js loaded successfully');
